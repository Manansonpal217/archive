...
export class CheatingDaddyApp extends LitElement {
    ...
    async _loadFromStorage() {
        try {
            ...
            this.selectedModel = prefs.selectedModel || 'llama3.2:3b';
    ...
    async handleStart() {
        // No API key check needed - using Ollama locally
    ...
    async handleModelChange(model) {
        ...
        await cheatingDaddy.storage.updatePreference('selectedModel', model);
    }
