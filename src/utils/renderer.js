...
async function initializeGemini(profile = 'interview', language = 'en-US') {
    ...
    const success = await ipcRenderer.invoke('initialize-gemini', null, prefs.customPrompt || '', profile, language);
    if (success) {
        ...
        if (isMacOS) {
            ...
            if (audioMode === 'mic_only' || audioMode === 'both') {
                ...
                try {
                    ...
                    // Start mic transcription (handled in main process when audio chunks arrive)
                } catch (micError) {
            ...
            if (audioMode === 'mic_only' || audioMode === 'both') {
                ...
                try {
                    ...
                    // Mic transcription will start automatically when audio chunks arrive
                } catch (micError) {
