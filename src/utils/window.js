...
function createWindow(sendToRenderer, geminiSessionRef) {
    ...
    // Defer content protection until after first paint — enabling it during init has
    // caused compositor hangs / black windows on some macOS + Electron combinations.
    mainWindow.webContents.once('did-finish-load', () => {
        setTimeout(() => {
            ...
            try {
                ...
                console.warn('setContentProtection failed:', e.message);
            }
        }, 400);
    });
